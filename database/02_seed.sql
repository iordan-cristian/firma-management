...
INSERT INTO kandidat (
    ...
    branchenkenntnisse, berufserfahrung, aktuelle_taetigkeiten, aktuelle_position, aktuelle_firma,
    ...
    ('dddddddd-dddd-dddd-dddd-dddddddddd01',
     ...
     'Automotive, Maschinenbau', 12,
     'Leitung von Entwicklungsprojekten, Teamführung',
    ...
    ('dddddddd-dddd-dddd-dddd-dddddddddd02',
     ...
     'IT, E-Commerce, FinTech', 6,
     'Produktentwicklung, Stakeholder Management, Agile Coaching',
    ...
    ('dddddddd-dddd-dddd-dddd-dddddddddd03',
     ...
     'Industrie, Produktion, Anlagenbau', 15,
     'Produktionsplanung, Qualitätssicherung, Lieferantenmanagement',
    ...
    ('dddddddd-dddd-dddd-dddd-dddddddddd04',
     ...
     'FMCG, Handel, digitale Medien', 8,
     'Content-Strategie, Social Media, Kampagnenmanagement',
    ...
    ('dddddddd-dddd-dddd-dddd-dddddddddd05',
     ...
     'Logistik, Supply Chain, Handel', 10,
     'Prozessoptimierung, Teamführung, Budgetplanung',
