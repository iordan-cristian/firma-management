-- Initial schema for firma_management.
-- Managed by Flyway — do not edit this file after it has been applied.
-- To change the schema, add a new migration: V2__description.sql
...
COMMENT ON COLUMN suchauftrag.deutsch            IS 'Enum: A1 | A2 | B1 | B2 | C1 | C2 | MUTTERSPRACHE';
COMMENT ON COLUMN suchauftrag.englisch           IS 'Enum: A1 | A2 | B1 | B2 | C1 | C2 | MUTTERSPRACHE';
